...
\end{cases}\\
u(x,t) = \sum_{n=1}^{\infty}b_{n}(t)\sin{\left(\frac{n\pi x}{\ell}\right)}\\
\sum_{n=1}^{\infty}\left[b_{n}''(t) +
\left(\frac{n\pi}{\ell}\right)^{2}b_{n}(t)\right]\sin{\left(\frac{n\pi x}{\ell}\right)} = h(x,t)
\end{gather*}
\end{minipage}
\begin{minipage}{0.5\textwidth}
\subsubsection*{Neumann}
...
\frac{b_{0}''(t)}{2} + \sum_{n=1}^{\infty}\left[b_{n}''(t) +
\left(\frac{n\pi}{\ell}\right)^{2}b_{n}(t)\right]\cos{\left(\frac{n\pi x}{\ell}\right)} = h(x,t)
\end{gather*}
\end{minipage}
